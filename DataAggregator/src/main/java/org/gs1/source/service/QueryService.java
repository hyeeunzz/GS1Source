...
public class QueryService {
	...
	public QueryService(DataQueryFactory dataQueryFactory, String queryType) {
	...
	public String query(String gtin, CountryCodeType targetMarket, String dataVersion) throws Exception {
		...
		if(rs == null) {
			//MongoDB
			DataQueryObject dataQueryObject = dataQueryFactory.getQueryObject(queryType);
			rs = dataQueryObject.queryData(gtin, targetMarket);
